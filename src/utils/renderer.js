...
const storage = {
    ...
    async setOpenrouterApiKey(key) {
        return ipcRenderer.invoke('storage:set-openrouter-api-key', key);
    },

    // Provider catalog
    async getProviderCatalog() {
        const result = await ipcRenderer.invoke('get-provider-catalog');
        return result.success ? result.data : {};
    },
};
...
function handleShortcut(shortcutKey) {
    ...
    // Ctrl+/ always triggers screen analysis regardless of current view
